...
<body>
    ...
    <!-- LOGO + HEADER -->
    <div class="header">
        <img src="{{ asset('images/coat_of_arms.png') }}" class="logo">
        <div><strong>REPUBLIC OF NAMIBIA</strong></div>
        <div class="ministry">
            {{ $ministry ?? 'MINISTRY OF LABOUR, INDUSTRIAL RELATIONS AND EMPLOYMENT CREATION' }}
        </div>
    </div>
